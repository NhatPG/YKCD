<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="PhongBan_DanhSach.aspx.cs" Inherits="YKCD.Province.Application.Admin.PhongBan_DanhSach" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <fieldset>
        <legend>DANH SÁCH PHÒNG BAN NỘI BỘ
        </legend>
    </fieldset>
    <asp:Panel ID="PanelHeadingControl" runat="server" class="row search-panel" DefaultButton="btnSearch">
        <div class="col-md-9">
            <a class="btn btn-success btn-sm" href="<%= Redirector.GetLink(ViewNames.Admin.PhongBan_QuanLy) %>">
        ...
        <ItemTemplate>
            <tr>
                <td class="text-center">
                    <input type="checkbox" id="chkItemId" runat="server" value='<%#Eval("DepartmentID") %>' />
                </td>
                <td>
                ...
                <td>
                    <a class="btn btn-success btn-sm" href="<%# Redirector.GetLink(ViewNames.Admin.PhongBan_QuanLy, "id", Eval("DepartmentID")) %>">
