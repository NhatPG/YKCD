<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Public_FunctionControl.ascx.cs" Inherits="YKCD.Province.Application.MasterPages.Controls.Public_FunctionControl" %>
<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav in" id="side-menu">
            <li style="padding-left: 10px">
                <a href="<%= Redirector.GetLink(ViewNames.Public.ThongKe_NguoiKyVanBan) %>">
                    <i class="glyphicon glyphicon-user" aria-hidden="true"></i><strong>LÃNH ĐẠO GIAO VIỆC</strong></a>
            </li>
            <li style="padding-left: 10px">
            ...
            <asp:Repeater ID="DanhSachNhomDonVi" runat="server">
                <ItemTemplate>
                    <li>
                        <a href="<%# Redirector.GetLink(ViewNames.Public.ThongKe_DonVi, "id", Eval("AgencyGroupID")) %>">
                            <%# Eval("AgencyGroupName") %></a>
                    </li>
                </ItemTemplate>
            </asp:Repeater>
            <li style="padding-left: 10px">
                <a href="<%= Redirector.GetLink(ViewNames.Public.ThongKe_NguoiTheoDoi) %>">
                    <i class="glyphicon glyphicon-user" aria-hidden="true"></i><strong>CHUYÊN VIÊN THEO DÕI</strong></a>
            </li>
            <li style="padding-left: 10px">
