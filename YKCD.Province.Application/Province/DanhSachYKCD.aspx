<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Province.Master" AutoEventWireup="true" CodeBehind="DanhSachYKCD.aspx.cs" Inherits="YKCD.Province.Application.Province.DanhSachYKCD" %>
        ...
        <ItemTemplate>
            <tr>
                ...
                <td class="nowrap" style="vertical-align: top !important">
                     <%# (Parameters.AgencyID > 0 || Sessions.AgencyID > 0) ? Eval("RequestStatusString") : Eval("PerformStatusString") %>
                </td>
            </tr>
        </ItemTemplate>
        <EmptyDataTemplate>
