<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Province.Master" AutoEventWireup="true" CodeBehind="TimKiem.aspx.cs" Inherits="YKCD.Province.Application.Province.TimKiem" %>
    ...
    <asp:Panel ID="Panel1" runat="server" DefaultButton="Search">
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    <asp:ListBox ID="DonViThucHien" runat="server" CssClass="select2 form-control input-sm" SelectionMode="Single"></asp:ListBox>
                </td>
            </tr>
            <tr>
                <td colspan="4" class="text-center">
                    <asp:LinkButton ID="Search" CssClass="btn btn-primary" OnClick="Search_OnClick" runat="server"><span class='glyphicon glyphicon-search'></span> Tìm kiếm</asp:LinkButton>
                </td>
            </tr>
        </table>
    </asp:Panel>
        ...
        <ItemTemplate>
            <tr>
                ...
                <td class="nowrap text-center">
                    <a href="<%# Redirector.GetLink(ViewNames.Province.ThongTinVanBan, "id", Eval("DocumentID")) %>"><strong><%# Eval("Document.DocumentCode") %></strong></a>
                    <br />
                    <%# Eval("Document.ReleaseDate").ToDateString() %>
                </td>
                <td>
                    <a href="<%# Redirector.GetLink(ViewNames.Province.ThongTinYKCD, "id", Eval("RequestID")) %>">
