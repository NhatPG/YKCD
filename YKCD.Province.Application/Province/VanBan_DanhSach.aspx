<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Province.Master" AutoEventWireup="true" CodeBehind="VanBan_DanhSach.aspx.cs" Inherits="YKCD.Province.Application.Province.VanBan_DanhSach" %>
    ...
    <asp:Panel ID="PanelHeadingControl" runat="server" CssClass="row search-panel" DefaultButton="btnSearch">
        <div class="col-md-9">
            <%--<a class="btn btn-success btn-sm"
                href="<%= Redirector.GetLink(ViewNames.Province.VanBan_QuanLy) %>">
    ...
    <asp:ListView ID="lvData" runat="server" ItemPlaceholderID="itemPlaceHolder"
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <a href="<%# Redirector.GetLink(ViewNames.Province.ThongTinVanBan, "id", Eval("DocumentID")) %>"><%# Eval("MainContent").ToString().Replace(Environment.NewLine, "<br />") %></a>
                </td>
                <td class="nowrap text-center">
                ...
                <td width="100px">
                    <a class="btn btn-success btn-sm" href="<%# Redirector.GetLink(ViewNames.Province.VanBan_QuanLy, "id", Eval("DocumentID")) %>">
