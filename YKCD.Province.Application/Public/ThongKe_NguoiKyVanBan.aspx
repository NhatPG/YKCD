<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Public.Master" AutoEventWireup="true" CodeBehind="ThongKe_NguoiKyVanBan.aspx.cs" Inherits="YKCD.Province.Application.Public.ThongKe_NguoiKyVanBan" %>
            ...
            <table class="table table-bordered table-striped table-hover">
                <thead>
                    <tr>
                        ...
                        <th rowspan="2" scope="col">Lãnh đạo ký văn bản</th>
