<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Public.Master" AutoEventWireup="true" CodeBehind="ThongKe_NguoiTheoDoi.aspx.cs" Inherits="YKCD.Province.Application.Public.ThongKe_NguoiTheoDoi" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <fieldset>
        <legend>TÌNH HÌNH THEO DÕI VIỆC THỰC HIỆN Ý KIẾN CHỈ ĐẠO CỦA UBND TỈNH </legend>
    </fieldset>
