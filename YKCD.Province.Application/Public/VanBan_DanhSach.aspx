<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Public.Master" AutoEventWireup="true" CodeBehind="VanBan_DanhSach.aspx.cs" Inherits="YKCD.Province.Application.Public.VanBan_DanhSach" %>
    ...
    <asp:ListView ID="lvData" runat="server" ItemPlaceholderID="itemPlaceHolder"
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <a href="<%# Redirector.GetLink(ViewNames.Public.ThongTinVanBan, "id", Eval("DocumentID")) %>"><%# Eval("MainContent").ToString().Replace(Environment.NewLine, "<br />") %></a>
                </td>
                <td class="nowrap text-center">
