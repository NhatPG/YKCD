<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="DonVi_DanhSach.aspx.cs" Inherits="YKCD.SubAgency.Application.Admin.DonVi_DanhSach" %>
    ...
    <asp:ListView ID="lvData" runat="server" ItemPlaceholderID="itemPlaceHolder"
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <a class="btn btn-success btn-sm" href="<%# Redirector.GetLink(ViewNames.Admin.DonVi_QuanLy, "id", Eval("DepartmentID")) %>">
