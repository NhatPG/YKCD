<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="DonVi_QuanLy.aspx.cs" Inherits="YKCD.SubAgency.Application.Admin.DonVi_QuanLy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <asp:TextBox ID="SoDienThoai" runat="server" CssClass="form-control input-sm"></asp:TextBox>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">
