<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="LoaiVanBan_DanhSach.aspx.cs" Inherits="YKCD.SubAgency.Application.Admin.LoaiVanBan_DanhSach" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <fieldset>
        <legend>DANH SÁCH LOẠI VĂN BẢN
        </legend>
    </fieldset>
    <asp:Panel ID="PanelHeadingControl" runat="server" class="row search-panel" DefaultButton="btnSearch">
        <div class="col-md-9">
            <a class="btn btn-success btn-sm" href="<%= Redirector.GetLink(ViewNames.Admin.LoaiVanBan_QuanLy) %>">
        ...
        <ItemTemplate>
            <tr>
                <td class="text-center">
                    <input type="checkbox" id="chkItemId" runat="server" value='<%#Eval("DocumentCategoryID") %>' />
                </td>
                <td>
                    <%# Eval("DocumentCategoryName") %>
                </td>
                <td class="text-center">
                    <%# Eval("DisplayOrder") %>
                </td>
                ...
                <td>
                    <a class="btn btn-success btn-sm" href="<%# Redirector.GetLink(ViewNames.Admin.LoaiVanBan_QuanLy, "id", Eval("DocumentCategoryID")) %>">
