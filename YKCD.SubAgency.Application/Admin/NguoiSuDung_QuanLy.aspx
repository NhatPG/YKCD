<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="NguoiSuDung_QuanLy.aspx.cs" Inherits="YKCD.SubAgency.Application.Admin.NguoiSuDung_QuanLy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <asp:ListBox ID="LoaiTaiKhoan" runat="server" CssClass="select2 form-control input-sm" Width="100%">
                    <Items>
                        <asp:ListItem Text="Lãnh đạo đơn vị" Value="6"></asp:ListItem>
                        <asp:ListItem Text="Lãnh đạo văn phòng" Value="9"></asp:ListItem>
                        <asp:ListItem Text="Chuyên viên văn phòng" Value="10"></asp:ListItem>
                        <asp:ListItem Text="Trưởng đơn vị, phòng ban" Value="7"></asp:ListItem>
                        <asp:ListItem Text="Chuyên viên đơn vị, phòng ban" Value="8"></asp:ListItem>
                        <asp:ListItem Text="Quản trị hệ thống" Value="2"></asp:ListItem>
                    </Items>
                </asp:ListBox>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <asp:TextBox ID="ThuTuHienThi" runat="server" CssClass="form-control input-sm"></asp:TextBox>
            </div>
            <label class="col-sm-3 control-label">
