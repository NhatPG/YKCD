<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="NhomDonVi_DanhSach.aspx.cs" Inherits="YKCD.SubAgency.Application.Admin.NhomDonVi_DanhSach" %>
        ...
        <ItemTemplate>
            <tr>
                <td class="text-center">
                    <input type="checkbox" id="chkItemId" runat="server" value='<%#Eval("DepartmentGroupID") %>' />
                </td>
                <td>
                    <a href="<%# Redirector.GetLink(ViewNames.Admin.DonVi_DanhSach, "id", Eval("DepartmentGroupID")) %>">
                        <strong><%# Eval("DepartmentGroupName") %></strong>
                    </a>
                </td>
                <td class="text-center">
                    <%# Eval("DisplayOrder") %>
                ...
                <td>
                    <a class="btn btn-success btn-sm" href="<%# Redirector.GetLink(ViewNames.Admin.NhomDonVi_QuanLy, "id", Eval("DepartmentGroupID")) %>">
