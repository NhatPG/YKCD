<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SubAgency_NarvBarControl.ascx.cs" Inherits="YKCD.SubAgency.Application.MasterPages.Controls.SubAgency_NarvBarControl" %>
<ul class="nav navbar-top-links navbar-right">
    <li class="<%= Request.Path.Contains(ViewNames.SubAgency.TimKiem) ? "active": ""%>">
