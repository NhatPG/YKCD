<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Public.Master" AutoEventWireup="true" CodeBehind="TimKiem.aspx.cs" Inherits="YKCD.SubAgency.Application.Public.TimKiem" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>
                <asp:ListBox ID="ChuyenVien" runat="server" CssClass="select2 form-control input-sm" SelectionMode="Multiple"></asp:ListBox>
            </td>
        </tr>
        <tr>
