<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SubAgency.Master" AutoEventWireup="true" CodeBehind="ThongKe_CapNhatVanBan.aspx.cs" Inherits="YKCD.SubAgency.Application.SubAgency.ThongKe_CapNhatVanBan" %>
    ...
    <asp:ListView ID="lvData" runat="server" ItemPlaceholderID="itemPlaceHolder">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <a href="<%# Redirector.GetLink(ViewNames.SubAgency.ThongTinVanBan, "id", Eval("DocumentID")) %>"><%# Eval("MainContent") %></a>
                </td>
                <td class="nowrap">
