<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SubAgency.Master" AutoEventWireup="true" CodeBehind="TimKiem.aspx.cs" Inherits="YKCD.SubAgency.Application.SubAgency.TimKiem" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>
                <asp:ListBox ID="ChuyenVienTheoDoi" runat="server" CssClass="select2 form-control input-sm" SelectionMode="Multiple"></asp:ListBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4" class="text-center">
                <asp:Button ID="Search" CssClass="btn btn-primary" OnClick="Search_OnClick" runat="server" Text="Tìm kiếm" />
            </td>
        </tr>
    </table>
        ...
        <ItemTemplate>
            <tr>
                ...
                <td class="nowrap" style="vertical-align: top !important">
                    <%# Parameters.DepartmentID > 0 ? Eval("RequestStatusString") : Eval("PerformStatusString") %>
                </td>
            </tr>
        </ItemTemplate>
    </asp:ListView>
