<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Agency.Master" AutoEventWireup="true" CodeBehind="BaoCao_QuanLy.aspx.cs" Inherits="YKCD.Agency.Application.Agency.BaoCao_QuanLy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
        ...
        <div class="form-group">
            <div class="col-sm-offset-3 col-sm-9">
                <asp:LinkButton ID="btnSave" runat="server" Text="<span class='glyphicon glyphicon-floppy-disk'></span>&nbsp;Lưu"
                    CssClass="btn btn-success" OnClick="btnSave_Click" OnClientClick="return CheckReportHaveFile();" />
            </div>
        </div>
    </div>
    ...
    <script>
        function CheckReportHaveFile() {
            if (validateForm()) {
                if ($('#<%=TrangThai.ClientID %> option:selected').val() == "2")
                {
