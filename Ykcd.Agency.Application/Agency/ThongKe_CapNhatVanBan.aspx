<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Agency.Master" AutoEventWireup="true" CodeBehind="ThongKe_CapNhatVanBan.aspx.cs" Inherits="YKCD.Agency.Application.Agency.ThongKe_CapNhatVanBan" %>
    ...
    <asp:ListView ID="lvData" runat="server" ItemPlaceholderID="itemPlaceHolder">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <a href="<%# Redirector.GetLink(ViewNames.Agency.ThongTinVanBan, "id", Eval("DocumentID")) %>"><%# Eval("MainContent") %></a>
                </td>
                <td class="nowrap">
