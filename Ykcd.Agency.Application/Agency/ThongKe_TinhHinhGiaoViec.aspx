<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Agency.Master" AutoEventWireup="true" CodeBehind="ThongKe_TinhHinhGiaoViec.aspx.cs" Inherits="YKCD.Agency.Application.Agency.ThongKe_TinhHinhGiaoViec" %>
    ...
    <asp:ListView ID="lvData" runat="server" ItemPlaceholderID="itemPlaceHolder"
        ...
        <ItemTemplate>
            <tr>
                ...
                <td class="nowrap">
                    <strong><%# Eval("RequiredDate").ToDateString() %></strong>
                </td>
                <td class="nowrap">
                    <%# Eval("RequesterID").ToInteger() > 0 ? UserServices.GetById(Eval("RequesterID").ToInteger()).FullName : "" %>
                </td>
