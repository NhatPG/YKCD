<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Agency.Master" AutoEventWireup="true" CodeBehind="VanBan_DanhSach.aspx.cs" Inherits="YKCD.Agency.Application.Agency.VanBan_DanhSach" %>
    ...
    <asp:Panel ID="PanelHeadingControl" runat="server" CssClass="row search-panel" DefaultButton="btnSearch">
        <div class="col-md-9">
            <a class="btn btn-success btn-sm"
                href="<%= Redirector.GetLink(ViewNames.Agency.VanBan_QuanLy) %>">
    ...
    <asp:ListView ID="lvData" runat="server" ItemPlaceholderID="itemPlaceHolder"
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <a class="btn btn-success btn-sm" href="<%# Redirector.GetLink(ViewNames.Agency.VanBan_QuanLy, "id", Eval("DocumentID")) %>">
