<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Agency.Master" AutoEventWireup="true" CodeBehind="VanBan_QuanLy.aspx.cs" Inherits="YKCD.Agency.Application.Agency.VanBan_QuanLy" %>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-offset-6 col-sm-6">
                ...
                <a class="btn btn-default btn-sm" href="<%= Redirector.GetLink(ViewNames.Agency.YKCD_QuanLy) %>">
