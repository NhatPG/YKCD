<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ThongTinVanBanControl.ascx.cs" Inherits="YKCD.Agency.Application.Controls.ThongTinVanBanControl" %>
<fieldset>
            ...
            <tbody>
                ...
                <tr style="<%# Eval("CoQuyenCapNhat").ToBoolean() ? "": "display: none" %>">
                    ...
                    <td colspan="2" class="text-right">
                        <a href="<%# Redirector.GetLink(ViewNames.Agency.YKCD_QuanLy, "pid", Eval("DocumentID")) %>" class="btn btn-primary btn-sm">
                            <span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>
                            Nhập ý kiến chỉ đạo
                        </a>
                        <a href="<%# Redirector.GetLink(ViewNames.Agency.VanBan_QuanLy, "id", Eval("DocumentID")) %>" class="btn btn-success btn-sm">
