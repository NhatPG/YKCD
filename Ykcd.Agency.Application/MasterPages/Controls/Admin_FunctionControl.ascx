<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Admin_FunctionControl.ascx.cs" Inherits="YKCD.Agency.Application.MasterPages.Controls.Admin_FunctionControl" %>
