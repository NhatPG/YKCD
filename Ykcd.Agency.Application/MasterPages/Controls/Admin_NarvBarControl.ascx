<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Admin_NarvBarControl.ascx.cs" Inherits="YKCD.Agency.Application.MasterPages.Controls.Admin_NarvBarControl" %>
