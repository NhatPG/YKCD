<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Agency_NarvBarControl.ascx.cs" Inherits="YKCD.Agency.Application.MasterPages.Controls.Agency_NarvBarControl" %>
<ul class="nav navbar-top-links navbar-right">
    <li class="<%= Request.Path.Contains(ViewNames.Agency.TimKiem) ? "active": ""%>">
        <a href="<%= Redirector.GetLink(ViewNames.Agency.TimKiem) %>">
