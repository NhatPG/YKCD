<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BannerControl.ascx.cs" Inherits="YKCD.Agency.Application.MasterPages.Controls.BannerControl" %>
            ...
            <tbody>
                <tr>
                    ...
                    <td style="text-align: left">
                        <p style="font-size: 17px; color: #fff; font-weight: bold"><%= AppSettings.AGENCY_NAME.ToUpper() %></p>
