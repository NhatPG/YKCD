<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Public_FunctionControl.ascx.cs" Inherits="YKCD.Agency.Application.MasterPages.Controls.Public_FunctionControl" %>
