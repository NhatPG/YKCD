<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DoiMatKhau.aspx.cs" Inherits="YKCD.Agency.Application.Public.DoiMatKhau" %>
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-4 col-sm-8">
                            ...
                            <a href="<%= Redirector.GetLink(ViewNames.Agency.BangThongKe) %>" class="btn btn-default">Hủy</a>
                            <br />
