<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Public.Master" AutoEventWireup="true" CodeBehind="ThongKe_NhomDonVi.aspx.cs" Inherits="YKCD.Agency.Application.Public.ThongKe_NhomDonVi" EnableViewState="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <asp:PlaceHolder ID="YkcdUbndTinhPanel" runat="server">
        <fieldset>
        <legend>TÌNH HÌNH THỰC HIỆN Ý KIẾN CHỈ ĐẠO CỦA UBND TỈNH</legend>
    </fieldset>
            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    <tr>
                        <td class="text-left">
                            <strong>
                                <a href="<%# Redirector.GetLink(ViewNames.Public.DanhSachYKCD, ParameterNames.YkcdUbndTinh, true) %>"><%= AppSettings.AGENCY_NAME %></a>
                            </strong>
                        </td>
